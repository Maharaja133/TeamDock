...
import { FaUserPlus, FaEdit, FaSearch, FaEnvelope, FaBriefcase, FaUserTag, FaUserShield, FaLock } from 'react-icons/fa';
...
const EmployeeList = () => {
  ...
  const fetchEmployees = async () => {
    try {
      ...
      if (err.response && err.response.status === 403) {
        setError("You must be an Administrator to view the employee directory.");
      } else {
  ...
  return (
    <div className="bg-indigo-50 p-4 md:p-6 rounded-xl">
      ...
      {error ? (
        <div className="bg-white border-t-4 border-red-500 rounded-xl p-8 text-center shadow-sm mt-4">
          <FaLock className="mx-auto text-red-400 text-4xl mb-4" />
